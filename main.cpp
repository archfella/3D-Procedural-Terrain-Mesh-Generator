...
#include "ImguiWindow/CustomizationWindow.h"
...
int main(int, char**) {
    ...
    Shader::SetGlobalShader(diffuseShader);
    ...
    currentShader->SetUniform1f("gHeight0", 50.0f);
    currentShader->SetUniform1f("gHeight1", 100.0f);
    currentShader->SetUniform1f("gHeight2", 150.0f);
    currentShader->SetUniform1f("gHeight3", 200.0f);
